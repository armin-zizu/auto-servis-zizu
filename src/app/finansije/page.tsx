...
export default function FinancePage() {
  ...
  const sections = [
    ...
    { href: '/finansije/troskovi', label: 'Troškovi', value: formatKm(finance.partsCost + finance.mechanicEarnings), description: 'Dijelovi i obračun majstorima', icon: Package, className: 'bg-amber-50 border-amber-200 text-amber-700' },
    ...
    { href: '/finansije/troskovi', label: 'Dobit', value: formatKm(finance.operatingProfit), description: 'Nakon dijelova i 10% rada majstorima', icon: TrendingUp, className: 'bg-violet-50 border-violet-200 text-violet-700' },
  ];

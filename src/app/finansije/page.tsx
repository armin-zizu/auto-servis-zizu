...
export default function FinancePage() {
  ...
  const sections = [
    ...
    { href: '/finansije/prihodi', label: 'Naplata rada', value: formatKm(finance.laborRevenue), description: 'Naplaćene ruke na zatvorenim nalozima', icon: Wrench, className: 'bg-cyan-50 border-cyan-200 text-cyan-700' },
    ...
    { href: '/finansije/troskovi', label: 'Dobit', value: formatKm(finance.operatingProfit), description: 'Prihod umanjen za nabavku dijelova', icon: TrendingUp, className: 'bg-violet-50 border-violet-200 text-violet-700' },
  ];
